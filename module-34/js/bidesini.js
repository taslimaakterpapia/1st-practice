...
const displayUser = user => {
  ...
  document.getElementById('name').innerHTML = name;
    ...
    location.innerHTML = user.results[0].location.street.number + ' ' + user.results[0].location.street.name + ' '  + user.results[0].location.city + ' ' + user.results[0].location.state ;
